            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative w-full max-w-2xl">
                  ...
                  />
                  <div className="absolute bottom-[30%] left-[20%] right-[20%] max-h-[30%]">
                    <div
                      className="grid grid-cols-2 gap-x-12 gap-y-1 p-4 auto-rows-min"
                      style={{ gridAutoFlow: 'column', gridTemplateRows: `repeat(${Math.ceil(championshipTrophyData.length / 2)}, minmax(0, 1fr))` }}
                    >
              ...
              <div className="flex flex-col items-center">
                <div className="relative w-full max-w-2xl">
                  <img
                    ...
                    style={{ mixBlendMode: 'multiply', opacity: 0.95 }}
                  />
                  <div className="absolute bottom-[27%] left-[20%] right-[20%] max-h-[30%]">
                    <div
                      className="grid grid-cols-2 gap-x-12 gap-y-1 p-4 auto-rows-min"
                      style={{ gridAutoFlow: 'column', gridTemplateRows: `repeat(${Math.ceil(toiletBowlTrophyData.length / 2)}, minmax(0, 1fr))` }}
                    >
